...
public class Triangle implements Intersectable {
    ...
    public Intersection [] findIntersections(Ray ray) {
        ...
        Intersection [] intersection = new Intersection[0]; // assume there is no intersection
        double t = 0;
        double beta = 0;
        double gamma = 0;
        double alpha = 0;
        try {
            ...
            t = solution.vector[0];
            beta = solution.vector[1];
            gamma = solution.vector[2];
            alpha = 1d - beta - gamma;
            ...
            if(0 <= alpha && alpha <= 1d &&
               ...
               0 <= gamma && gamma <= 1d) {
                ...
                intersection[0] = new Intersection(t, beta, gamma);
            } 
        } catch (Exception e) {
            System.out.println(e);
        }
        if(DEBUG)
            System.out.println("t: " + t + " beta: " + beta + " gamma: " + gamma);
        return intersection;
    }
    ...
    public static void main(String [] args) {
        ...
        try {
            ...
            if(solution.length == 1) {
                ...
                System.out.println(ray.evaluate(solution[0].t));
            }
        } catch (Exception e) {
            System.out.println(e);
        }
